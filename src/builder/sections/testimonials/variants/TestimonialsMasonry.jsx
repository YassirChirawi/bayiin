            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8 max-w-7xl mx-auto">
                    {displayItems.map((item, index) => (
                        ...
                        >
                            <div className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col relative overflow-hidden group hover:-translate-y-1">
