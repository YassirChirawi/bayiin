...
export default function Landing() {
    ...
    return (
        <div className={`bg-slate-950 min-h-screen font-sans text-slate-900 overflow-x-hidden ${isRTL ? 'font-arabic' : ''}`} dir={isRTL ? 'rtl' : 'ltr'}>
            <SEO
            ...
            <FloatingCTA />
            {/* Navbar */}
            <nav className="fixed w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-white/10 transition-all duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <Link to="/" className="flex items-center gap-2 group hover:opacity-80 transition-opacity">
                            ...
                            <span className="font-bold text-2xl tracking-tight text-white group-hover:text-indigo-400 transition-colors">BayIIn</span>
                        </Link>

                        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
                            <a href="#hero" className="hover:text-indigo-400 transition-colors">{t('nav_home')}</a>
            ...
            <section id="hero" className="pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center relative overflow-hidden">
                {/* Dark Background Icons Pattern */}
                <div className="absolute inset-0 z-0 select-none overflow-hidden pointer-events-none opacity-20">
                    <div className="absolute top-10 left-10 text-indigo-500 rotate-12 transform"><ShoppingBag className="w-24 h-24" /></div>
                    <div className="absolute top-20 right-20 text-purple-500 -rotate-12 transform"><ShoppingCart className="w-32 h-32" /></div>
                    <div className="absolute bottom-20 left-1/4 text-indigo-500 rotate-45 transform"><DollarSign className="w-40 h-40" /></div>
                    <div className="absolute top-1/3 right-10 text-pink-500 rotate-6 transform"><Smartphone className="w-20 h-20" /></div>
                    <div className="absolute bottom-10 right-1/3 text-slate-400 -rotate-6 transform"><Package className="w-28 h-28" /></div>
                    <div className="absolute top-1/2 left-0 text-indigo-300 rotate-12 transform"><Truck className="w-16 h-16" /></div>
                    <div className="absolute top-10 left-1/3 text-green-500 -rotate-12 transform"><CreditCard className="w-14 h-14" /></div>
                </div>

                {/* Dark Background Decoration */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-gradient-to-tr from-indigo-900 via-purple-900 to-slate-900 rounded-[100%] blur-[120px] -z-10 opacity-60"></div>
                ...
                >
                    ...
                    <p className="text-3xl md:text-5xl text-white mb-6 max-w-4xl mx-auto leading-relaxed font-arabic font-bold drop-shadow-sm" dir="rtl">
                        ...
                        {language === 'ar' ? null : <span className="text-indigo-400 block mb-2 font-arabic text-2xl md:text-3xl">بايعين.. باش يبقى الرزق باين والحساب باين.</span>}
                    </p>

                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-none mb-6 text-white">
                        {t('hero_title_1')} <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">{t('hero_title_2')}</span>
                    </h1>
            ...
            {/* INTERACTIVE SIGNUP PREVIEW */}
            <InteractiveSignupPreview />
