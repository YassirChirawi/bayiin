...
export default function Finances() {
    ...
    orders.forEach(order => {
        ...
        // Global totals (optional, maybe we want filtered totals only?)
        // Let's make the main Stats reflect the FILTERED date range, except maybe "RevenueToday" which is specific.
    ...
    const filteredExpenses = expenses
        .filter(exp => {
            // If expense has no date, assume it's recent? Or ignore? 
            // Expenses from before might allow date, assume today if missing.
    ...
    return {
        ...
        revenueWeek,
        revenueMonth,
        totalRevenue: filteredRevenue, // Display Filtered Revenue
        totalCOGS,
